...
init -1 python hide:
    ...
    config.window_title = u"Doki Doki Princess Investigator"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Doki Doki Princess Investigator"
    config.version = "0.0"
...
python early:
    config.save_directory = "Doki Doki Princess Investigator-1400341373"
...
init python:
    ...
    build.directory_name = "DokiDokiPrincessInvestigator-1.1a"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Doki Doki Princess Investigator"
